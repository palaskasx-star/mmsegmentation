...
python tools/dist_train.sh \
    ...
    --cfg-options model.backbone.checkpoint_path=../pretrained_models/models/dinov3_architecture/without_teacher/tiny/checkpoint_epoch_300_mmseg.pth train_dataloader.batch_size=2
...
python tools/dist_train.sh \
    ...
    --cfg-options model.backbone.checkpoint_path=../pretrained_models/models/dinov3_architecture/without_teacher/small/checkpoint_epoch_300_mmseg.pth train_dataloader.batch_size=2
...
python tools/dist_train.sh \
    ...
    --cfg-options model.backbone.checkpoint_path=../pretrained_models/models/dinov3_architecture/manifold/Dinov3Small_t_Dinov3Tiny_s/checkpoint_epoch_300_mmseg.pth train_dataloader.batch_size=2
...
python tools/dist_train.sh \
    ...
    --cfg-options model.backbone.checkpoint_path=../pretrained_models/models/dinov3_architecture/manifold/Dinov3Base_t_Dinov3Small_s/checkpoint_epoch_300_mmseg.pth train_dataloader.batch_size=2
...
python tools/dist_train.sh \
    ...
    --cfg-options model.backbone.checkpoint_path=../pretrained_models/models/dinov3_architecture/gaussian_kernel/tiny/checkpoint_epoch_300_mmseg.pth train_dataloader.batch_size=2
...
python tools/dist_train.sh \
    ...
    --cfg-options model.backbone.checkpoint_path=../pretrained_models/models/dinov3_architecture/gaussian_kernel/small/checkpoint_epoch_300_mmseg.pth train_dataloader.batch_size=2
...
python tools/dist_train.sh \
    ...
    --cfg-options model.backbone.checkpoint_path=../pretrained_models/models/dinov3_architecture/cosine_kernel/tiny/checkpoint_epoch_300_mmseg.pth train_dataloader.batch_size=2
...
python tools/dist_train.sh \
    ...
    --cfg-options model.backbone.checkpoint_path=../pretrained_models/models/dinov3_architecture/cosine_kernel/small/checkpoint_epoch_300_mmseg.pth train_dataloader.batch_size=2
